...
- Packages are installed with the **install.packages** function loaded with the **library** function, oner per session:
...
**canyoureadthissentence? WhatAboutThisOne? how_about_this_one?**
--
