...
What other information would we want to include about our data set?
*Answer here*
...
#install.libraries("janitor") #for tabyl function (similar to table function)
#install.libraries("skimr") #for skim function (similar to summary function)
```


We need to read in our data. You can download the **TrainingWiDS2021** and **DataDictionaryWiDS2021** [here](https://www.kaggle.com/c/widsdatathon2021/data)
```{r read-data, message=F, warning=F}
training <- read_csv("~/Downloads/TrainingWiDS2021.csv")
dictionary <- read_csv("~/Downloads/DataDictionaryWiDS2021.csv")
```
...
Notice, the first column is just the left-over indeces from the csv file. We can go ahead and remove that.
...
## Q&A
1. Look through the n_missing and complete_rate columns outputted by the `skim` command. What are these variables telling us? How could would we use this information in our analysis? 
*Answer here*
2. Which of the variable types have the most complete data? Why do you think this is?
*Answer here*
3. What variables do you think we could let go of down the line? 
*Answer here*
